...
const Home: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1551807516-b03a52e10f87?w=400&h=300&fit=crop',
  ...
  const features = [
    ...
    },
    {
      icon: Truck,
      title: 'Free Shipping',
      description: 'Free shipping on orders over $99 with fast delivery'
    },
    {
      icon: Clock,
      title: '24/7 Support',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              />
              <div className="absolute -bottom-6 -left-6 bg-accent-500 text-white p-4 rounded-lg shadow-lg">
